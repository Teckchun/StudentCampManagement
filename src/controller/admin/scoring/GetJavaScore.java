...
/**
 * Servlet implementation class GetJavaScore
 */
@WebServlet("/GetJavaScore")
public class GetJavaScore extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		float java = AdminDAO.getScorePercent("SUB002");
