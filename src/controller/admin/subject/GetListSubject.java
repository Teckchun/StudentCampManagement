...
/**
 * Servlet implementation class GetListSubject
 */
@WebServlet("/GetListSubject")
public class GetListSubject extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		ArrayList<Subject> subjects= SubjectDAO.listSubject();
