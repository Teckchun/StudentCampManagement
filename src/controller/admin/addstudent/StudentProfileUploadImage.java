...
@WebServlet("/UserImageUpdate")
public class StudentProfileUploadImage extends HttpServlet {
/**
	 * 
	 */
     ...
     */
    public StudentProfileUploadImage() {
        super();
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		String UPLOAD_DIRECTORY = request.getServletContext().getRealPath("imgprofiles");
