...
/**
 * Servlet implementation class UpdateStudentStatus
 */
...
public class UpdateStudentStatus extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println(stuid+" "+stustatus);
		
		  int sta=Integer.parseInt(stustatus);
		  boolean status=new StudentDAO().changeStudentStatus(stuid, sta);
	      if(status){
