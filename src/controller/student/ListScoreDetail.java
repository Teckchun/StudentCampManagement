...
/**
 * Servlet implementation class ListScoreDetail
 */
@WebServlet("/ListScoreDetail")
public class ListScoreDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListScoreDetail() {
        super();
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		ArrayList<Score> stuscore=StudentDAO.listScoreDetail(stuid);
