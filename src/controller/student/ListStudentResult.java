...
/**
 * Servlet implementation class ListStudentResult
 */
@WebServlet("/ListStudentResult")
public class ListStudentResult extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		ArrayList<Score> sturesult=StudentDAO.listStudentResult(generation,course,stuclass, month);
