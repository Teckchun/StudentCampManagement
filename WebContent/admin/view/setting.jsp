...
<title>Insert title here</title>
   ...
   <link rel="stylesheet" href="plugin/boostrapvalidator/css/bootstrapValidator.css"/>
   ...
   <link rel="icon" href="images/hrdlogo.png" type="image/png" >
  	...
  	<script type="text/javascript" src="plugin/boostrapvalidator/js/bootstrapValidator.js"></script>
  	<style>
  		span.tickicon{
  			color:#8BC34A;
  			font-size: 20px;
	  ...
	  <div class="modal-dialog">
		<div class="modal-content" >
			  ...
			  <div class="modal-body header-err">
				<button type="button" id="closeboxalert" class="close" data-dismiss="modal">&times;</button>
				<h5>ERROR !!!</h5>
			  </div>
			  <!-- dialog buttons -->
